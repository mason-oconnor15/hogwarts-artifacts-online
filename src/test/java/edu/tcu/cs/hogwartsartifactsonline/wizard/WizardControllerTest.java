...
public class WizardControllerTest {
    ...
    void testAssignArtifactSuccess() throws Exception {
        ...
        this.mockMvc.perform(put(this.baseUrl+"/wizards/2/artifacts/1250808601744904191").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
                .andExpect(jsonPath("$.message").value("Artifact Assignment Successful"))
                .andExpect(jsonPath("$.data").isEmpty());
    }
    @Test
    ...
    void testAssignArtifactErrorWithNonExistenArtifactId() throws Exception {
        ...
        //When and Then
        this.mockMvc.perform(put(this.baseUrl+"/wizards/5/artifacts/1250808601744904199").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
